...
export const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  const getProductInfo = (id: string) => {
    let p1 = PRODUCTS.find((p) => p.id === id);
    if (p1) {
      const units = cart[id] * p1.packSize;
      const hasOffer = p1.badge === 'offer' || !!p1.offerPercentage;
      const price = hasOffer && p1.offerPercentage ? p1.unitPrice * (1 - p1.offerPercentage / 100) : p1.unitPrice;
      return { name: p1.name, units, price, rootImage: null, isLegacy: true };
    }
        ...
        <Animated.View style={{
          ...
          {step !== 'success' && (
            <View style={{
              ...
              paddingHorizontal: 24, paddingTop: 32, paddingBottom: 16, backgroundColor: '#fff',
            ...
            <View style={{ flex: 1 }}>
              {isLoading ? (
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 }}>
                  ...
                  <Pressable onPress={handleClose} style={{ backgroundColor: THEME, paddingHorizontal: 32, paddingVertical: 14, borderRadius: 12 }}>
